 ...
 *     title: '회사 소개',
 *     subtitle: 'Carib Team',
 *     description: 'AI 업무 자동화 전문가 그룹',
 *   });
 * }
 * ```
 */
export function generateOGImage({ title, subtitle, description }: OGImageOptions) {
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          {/* Brand name - smaller when there's custom title */}
          <div
            style={{
              fontSize: 48,
              fontWeight: 700,
...
/**
 * 특정 페이지의 메타데이터에 사용할 OG 이미지 설정을 생성합니다.
 */
